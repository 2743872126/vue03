<template>
  <div style=" width: 72%;margin-left: 12%" >
        ...
        <div style="width: 180px;height: 50px;line-height: 50px;float: left;margin-right: 4px;background-color:ghostwhite;" @click="toWorkDynamic()">
          我关注的更新</div>
        <div style="width: 130px;height: 50px;line-height: 50px;float: left;margin-right: 4px;background-color: crimson;color: white">全站更新</div>
        <div style="width: 740px;height: 50px;line-height: 50px;float: left;background-color: ghostwhite;margin-bottom: 20px"></div>
