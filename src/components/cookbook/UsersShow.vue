    ...
    <div>
      <div style=" width: 80%;margin-left: 10%">
        ...
        <div style="height: 500px;width:70%;float: left">
          <!--{{users}}-->
          <div style="height: 140px;margin-bottom:20px;position: relative;width: 50%;float: left" v-for="v,i in users.slice(0,30)">
            ...
            <el-button  style="background-color: crimson;color: white;width: 100px;height: 50px;font-size: 22px;position: absolute;top: 35px;left: 245px"  v-show="v.uid!==user.uid" @click="guanzhu2(i)">
